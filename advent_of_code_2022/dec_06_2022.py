...
def find_unique(input_stream, n=4):
    """Finds the last position of a unique pattern of length n

    Args:
        input_stream: string of datastream
        n: number of unique characters to look for
    Returns:
        integer indicating end of unique string or -1 if not found
    """
    for i in range(len(input_stream)):
        substream = input_stream[i:i+n]
